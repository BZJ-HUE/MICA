...
class Encoder_overall(Module):
    """Overall encoder for MICA 2.0 with cross-modal feature fusion"""
    ...
    def forward(self, features_omics1, features_omics2,
        ...
        if features_omics1_enhanced is not None:
            ...
            # 向后兼容：如果没有提供融合特征，使用原始特征
            emb_latent_augmented_omics1 = self.encoder_omics1_augmented(
                features_omics1, adj_augmented_omics1
            )
        ...
        if features_omics2_enhanced is not None:
            ...
            emb_latent_augmented_omics2 = self.encoder_omics2_augmented(
                features_omics2, adj_augmented_omics2
            )
